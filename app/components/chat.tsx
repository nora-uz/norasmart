        ...
        <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
          <div style={{ width: "100%", maxWidth }}>
            ...
            <div style={{
              ...
              <img
                ...
                style={{
                  ...
                  marginBottom: 0 // нет отступа под фото
                }}
              />
            </div>
            {/* --- Блок описания вплотную --- */}
            ...
            <div style={{ width: "100%", display: "flex", justifyContent: "center", marginTop: 0 }}>
              ...
              >
                <span style={{
                  display: "flex", alignItems: "center", justifyContent: "center", color: NORA_COLOR
                }}>
            ...
            <div key={idx} style={{ display: "flex", width: "100%", justifyContent: msg.sender === "user" ? "flex-end" : "flex-start" }}>
              <div style={{ margin: "20px", maxWidth: 450, alignSelf: msg.sender === "user" ? "flex-end" : "flex-start" }}>
                {msg.sender === "user" ? (
                  ...
                  <div>
                    <ReactMarkdown
                      children={formatBotText(msg.text)}
                      components={{
                        strong: props => <strong style={{ fontWeight: 700 }}>{props.children}</strong>,
                        p: props => <p style={{ margin: "0 0 20px 0", fontWeight: 400, color: NORA_COLOR, fontSize: 17, lineHeight: 1.8, wordBreak: "break-word" }}>{props.children}</p>
                      }}
                    />
                  </div>
                )}
          ...
          {botProgress && (
            <div style={{ display: "flex", width: "100%", justifyContent: "flex-start" }}>
              <div style={{ margin: "20px", maxWidth: 450 }}>
                <ReactMarkdown
                  children={formatBotText(botProgress)}
                  components={{
                    strong: props => <strong style={{ fontWeight: 700 }}>{props.children}</strong>,
                    p: props => <p style={{ margin: "0 0 20px 0", fontWeight: 400, color: NORA_COLOR, fontSize: 17, lineHeight: 1.8, wordBreak: "break-word" }}>{props.children}</p>
                  }}
