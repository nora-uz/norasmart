...
// --- Welcome-панель, фикс на обоих экранах ---
const HeaderPanel = () => (
  <div style={{
  ...
  return (
    <div style={{ background: "#f8fdff", minHeight: "100vh" }}>
      ...
      {!showWelcome && (
        <>
          <HeaderPanel />
          {/* Дальше выводишь свой экран чата, сообщения, инпут */}
          {/* ... */}
          <div style={{ textAlign: "center", fontSize: 17, marginTop: 50 }}>
            Здесь основное содержимое чата. Теперь welcome-экран отключён!
          </div>
        </>
      )}
    </div>
